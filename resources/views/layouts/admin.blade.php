...
<html lang="en">
	...
	<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-sidebar-stacked="true" data-kt-app-sidebar-secondary-enabled="true" class="app-default">
        ...
        <script src="{{ asset('assets/js/admin/widgets.bundle.js') }}"></script>
        <script src="{{ asset('assets/js/admin/custom/widgets.js') }}"></script>
        <script src="{{ asset('assets/js/admin/custom/apps/chat/chat.js') }}"></script>
        <script src="{{ asset('assets/js/admin/custom/utilities/modals/upgrade-plan.js') }}"></script>
        <script src="{{ asset('assets/js/admin/custom/utilities/modals/new-target.js') }}"></script>
        <script src="{{ asset('assets/js/admin/custom/utilities/modals/new-address.js') }}"></script>
        <script src="{{ asset('assets/js/admin/custom/utilities/modals/users-search.js') }}"></script>
